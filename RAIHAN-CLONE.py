...
"""%(N))                                                    
───────────────────────────────────────────────────────
 [\x1b[1;96m+%s] Nama       : RAIHAN
 [\x1b[1;96m+%s] WhatsApp   : 01618921827
 [\x1b[1;96m+%s] Facebook   : Prince Raihan M.M.M
 [\x1b[1;96m+%s] Github      : https://github.com/Rehat420/OLD-CRACK
───────────────────────────────────────────────────────\n'''%(N,N,N,N))
def kontol():
    os.system("clear")
    print(f"""       ___  ___   ______ _____   _  __
  / _ \/ _ | /  _/ // / _ | / |/ /
 / , _/ __ |_/ // _  / __ |/    / 
...
{P}[•]{B}----------------------------------------------------{P}[•]
{B} |
{P}[•] AUTHOR: RAIHAN-KHAN
{P}[•] WHATSAPP: 01618921827
{B}[•] FACEBOOK: Prince Raihan M.M.M""")
def licensi():#line:42
  try :#line:43
    os .system ('clear')
    kontol()
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s [Raihan-XD] %s/%s •_• [OK] %s •_• [CP] %s •_• %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
